...
/**
 * Класс поискового движка с реализацией индексации по словам
 */
public class BooleanSearchEngine implements SearchEngine {
    SearchEngineMap searchEngineMap;

    /**
     * Метод реализации индексации слов содержащихся в PDF
     */
    ...
    /**
     * Метод реализации поиска заданного слова(набор слов) по индексу
     */
    @Override
